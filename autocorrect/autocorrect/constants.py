word_regexes = {
    ...
    "my": r"[АаБбВвГгДдЕеЁёЖжЗзИиЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщЪъЫыЬьЭэЮюЯя]+",
...
alphabets = {
    ...
    "my": "шиюынжсяплзухтвкйеобмцьёгдщэарчфъ",
...
ipfs_paths = {
    ...
    "my_ru": ["QmbRSZvfJV6zN12zzWhecphcvE9ZBeQdAJGQ9c9ttJXzcg/my.tar.gz"],
